...
export const LoadingStateResetContext = createContext<null | (() => void)>(null);
...
const LoadingStateResetContextProvider = function(children:ReactNode,resetter: () => void){
    return (
...
export const PostContextProvider = function(children:ReactNode, resetter: () => void){
