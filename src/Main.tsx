            ...
            <main>
              ...
              {userNotValid ? (
                <>
                  ...
                  {!user || userAdmin || (
                    <Typography align="center" component="h2" variant="h5">
                      It looks like you do not have administrative privileges to
                      access this page. You can{" "}
                ...
                <>
                  {postsAreLoaded && (
                    <Grid container spacing={4}>
                      <Grid item sx={{ minWidth: "100%" }}>
                        <Box sx={{ float: "right" }}>
                          <FormDialog
                            {...addPostProps((user as UserInterface)._id)}
                          />
                        </Box>
                      </Grid>
                  ...
                  {postsNotLoaded && (
                    <Typography align="center" component="h2" variant="h5">
                      {" "}
                      Posts data has not been retrieved from API.
                    </Typography>
                  )}
                </>
              )}
